...
const ui = {
  "pt-BR": {
    ...
    fileSection: "Arquivo",
    driveIn: "Login no Drive",
    driveOut: "Logout do Drive",
    ...
    highlightHint: "Escolha cor, selecione texto e clique abaixo",
    highlight: "Grifar",
    grifoColors: "Cor e etiqueta (mude para sua pref.)",
    bookCrumb: "LDE",
    filter: "Filtrar…",
  ...
  "en-US": {
    ...
    fileSection: "File",
    driveIn: "Login to Drive",
    driveOut: "Logout from Drive",
    ...
    highlightHint: "Pick a color, select text, then click below",
    highlight: "Highlight",
    grifoColors: "Color and label (change to your preference.)",
    bookCrumb: "LDE",
    filter: "Filter…",
    searchBtn: "Search",
...
function tabBar(active) {
  const setOn = state.showSettings ? "on" : "";
  return `<nav class="tabbar">
    <div class="tabs">
      ...
      <button type="button" class="${setOn}" data-act="open-settings" title="${t("settings")}" aria-label="${t("settings")}"><i data-icon="settings"></i><span>${t("settings")}</span></button>
    </div>
  </nav>`;
}

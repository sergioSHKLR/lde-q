 ...
 * same wrapper as sergioSHKLR/librus-shell src/icons.js.
 * Usage: <i data-icon="star"></i> then hydrateIcons(root)
 */
const PATHS = {
  droplet: '<path d="m12 4.5 4.6 4.6a7.4 7.4 0 1 1-9.2 0Z"/>',
  house:
  ...
  "eye-off":
    '<path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.744 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/><path d="m2 2 20 20"/>',
...
const ALIAS = { home: "house", share: "share-2" };
...
export function iconSvg(name, opts = {}) {
  ...
  const aria = opts.label != null ? ` role="img" aria-label="${opts.label}"` : ' aria-hidden="true"';
  return (
